...
var sitelayouts = ['site-layout-margin-unit','site-background-margins-heading', 'site-layout-margin-top',
...
'site-layout-margin-right'];
	...
	wp.customize( 'site-layout' ,function( value ) {
		...
		_.each( sitelayouts, function ( controlsetting ) {
				...
				customize.control(controlsetting).deactivate({duration: 0});
		...
		_.each( sitelayouts, function ( controlsetting ) {
				...
				customize.control(controlsetting).activate({duration: 0});

 ...
 * Home Page Setup
    ...
    * Configuring the front Page display setting.
    ...
    Detailed Documentation can be found here https://docs.rarathemes.com/docs/wedding-band
...
Source:
    - https://pxhere.com/en/photo/725699
    - https://pxhere.com/en/photo/1057722

License: CCO
    - https://pxhere.com/en/license

-- Wedding Band bundles the following third-party resources --
...
Wedding Band Theme, Copyright Rara Theme 2015, rarathemes.com
...
== Changelog ==
    ...
    * Fixed calendar widget design issue for WordPress 5.5.1
    * Added tested up to and require php in style
    * Changed demo link
    * Replaced owl.carousel.aria.js by owlcarousel2-a11ylayer.js

    1.1.7
    * Fixed posts margin issue in single post. 
    ...
    * Made footer link no-follow.
    ...
    1.1.2
    * Double icon issue fixed in mobile devices.
